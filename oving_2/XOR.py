...
print("Model 1 W1 = %s, b1 = %s, W2 = %s, b2 = %s, loss = %s" % (model.b1, model.W1, model.W2, model.b2,
                                                                 model.loss(train_x, train_y)))
print("Model 2W1 = %s, b1 = %s, W2 = %s, b2 = %s, loss = %s" % (model2.b1, model2.W1, model2.W2, model2.b2,
                                                                model2.loss(train_x, train_y)))
...
def plotModel(model, plot, color):
    ...
    plot.plot_wireframe(x1_grid, x2_grid, y_grid, color=color)


plotModel(model, plot1, "blue")
plotModel(model2, plot1, "red")
